...
Since we are using the ONNX Runtime, the frame provided in the `post-process` hook parameters is the original frame (check the [ONNX docs page](/docs/v0/inference) to learn why).
