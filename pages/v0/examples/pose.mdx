...
In this case, we make use of the `pipeless_ai_tf_models` package to import the [multipose estimation model](/docs/v0/models/tensorflow/multi-pose-estimation), we don't even have to bring our own model, everything is ready to use.
