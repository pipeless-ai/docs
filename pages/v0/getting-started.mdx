...
Right now, there are no significant differences between these hooks, they are invoked in order piping their outputs and simply exist to help creating a logical code structure in your application.
