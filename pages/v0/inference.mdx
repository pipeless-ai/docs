...
Check the list of configuration options for the automatic pre-processing in the [configuration options list](/docs/v0/configuration) under the `worker.inference` key.
...
Optionally, you can use the Pipeless CUDA container image. Find the docs [here](/docs/v0/container).
