...
* [Multi-pose estimation](/docs/v0/models/tensorflow/multi-pose-estimation): Detects up to 6 people. Returns bounding boxes for the people and 17 keypoints (nose, left eye, right eye, left ear, ...)

### YOLOv8 models

Check the [YOLOv8 plugin](/docs/v0/plugins/yolov8) to run yolo models out of the box.
