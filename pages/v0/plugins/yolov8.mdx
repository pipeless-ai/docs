...
By installing this plugin your Pipeless application will automatically execute the specified YOLO model before the `process` hook.
...
The model is automatically downloaded when you run your Pipeless application. By default, the `yolov8n.pt` detection model is loaded.
To change the default model simply export the `PIPELESS_PLUGIN_YOLOV8_MODEL` environment variable:
