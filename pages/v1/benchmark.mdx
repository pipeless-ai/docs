...
situation where the "glue" of your code has zero latency (note that is not possible).
...
* Process (inference) avg. time: `152ms`
* Post-process avg. time: `3.3ms`

* Hypothetical ideal FPS: `6.43` (`1/ ((152 + 3.3)/1000)`)
* Actual FPS: `6.17`. Pipeless added on avg `1.2ms` per frame
