...
In this example we use two different stages. One is the same as the [YOLO example](/v1/examples/yolo) and the other is the stage that performs the actual tracking.
