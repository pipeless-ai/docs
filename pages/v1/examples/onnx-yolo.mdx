...
This example makes use of the ONNX Runtime to run object detection using a YOLO model. It differs from the [YOLO example](/v1/examples/yolov8) in that the later uses the Ultralytics SDK (Pytorch).
