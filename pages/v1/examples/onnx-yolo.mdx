...
<Callout>
Due to a poor implementation of the post-processing in this example it may seem to take more time than the Ultralytics SDK, however,
you can verify the inference times are the same. The differences come from the pre and post-processing Python implementation of this example.
This example is just a guide about how to use the ONNX runtime, you should not use it in production because the results will be poor due to the stated reason
</Callout>
