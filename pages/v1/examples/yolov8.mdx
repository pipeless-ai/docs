...
<Callout>
This example uses YOLOv8 by importing the Ultralytics Python library, unlinke the [`onnx-yolo` example](/v1/examples/onnx-yolo), which loads the YOLO model into the ONNX Runtime.
</Callout>
